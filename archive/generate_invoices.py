...
Documents created (7 of 10 line items — INV-004, INV-006, INV-007 intentionally omitted):
  INV-001  Legal Counsel - Kirkland & Ellis LLP          $750,000
  INV-002  Accounting & Audit Fees - Deloitte LLP        $250,000
  INV-003  Banking Advisory - Goldman Sachs & Co       $1,500,000
  INV-004  Due Diligence - FTI Consulting                $300,000  ← MISSING (no file)
  INV-005  Environmental Assessment - ERM Group           $75,000
  INV-006  Tax Advisory - PricewaterhouseCoopers LLP     $150,000  ← MISSING (no file)
  INV-007  Regulatory Filing Fees - HSR/SEC               $30,000  ← MISSING (no file)
  INV-008  Miscellaneous Closing Costs                    $15,000
  EMAIL-001 IT Due Diligence - Alvarez & Marsal           $85,000
...
# ── INV-001: Kirkland & Ellis ─────────────────────────────────────────────────
pdf = FPDF()
base_invoice(pdf, "Kirkland & Ellis LLP",
             ["601 Lexington Avenue", "New York, NY 10022", "Tel: (212) 446-4800"],
             "KE-2026-03142", "March 3, 2026")
...
pdf.output(os.path.join(OUT, "INV-001_Kirkland_Ellis.pdf"))
print("Created INV-001_Kirkland_Ellis.pdf")


# ── INV-002: Deloitte ─────────────────────────────────────────────────────────
pdf = FPDF()
base_invoice(pdf, "Deloitte LLP",
             ["30 Rockefeller Plaza", "New York, NY 10112", "Tel: (212) 492-4000"],
             "DT-2026-00891", "February 28, 2026")
line_items_table(pdf, [
...
pdf.output(os.path.join(OUT, "INV-002_Deloitte.pdf"))
print("Created INV-002_Deloitte.pdf")


# ── INV-003: Goldman Sachs ────────────────────────────────────────────────────
pdf = FPDF()
base_invoice(pdf, "Goldman Sachs & Co. LLC",
             ["200 West Street", "New York, NY 10282", "Tel: (212) 902-1000"],
             "GS-2026-TX-0047", "March 3, 2026")
line_items_table(pdf, [
...
pdf.output(os.path.join(OUT, "INV-003_Goldman_Sachs.pdf"))
print("Created INV-003_Goldman_Sachs.pdf")


# ── INV-004: FTI Consulting ── INTENTIONALLY OMITTED ─────────────────────────
# Due Diligence - $300,000 — no file created
print("SKIPPED INV-004_FTI_Consulting.pdf (intentional gap)")


# ── INV-005: ERM Group ───────────────────────────────────────────────────────
pdf = FPDF()
base_invoice(pdf, "ERM Group",
             ["One Penn Plaza, Suite 1225", "New York, NY 10119", "Tel: (212) 367-0400"],
             "ERM-2026-1847", "February 20, 2026")
line_items_table(pdf, [
...
pdf.output(os.path.join(OUT, "INV-005_ERM_Group.pdf"))
print("Created INV-005_ERM_Group.pdf")


# ── INV-006: PwC ── INTENTIONALLY OMITTED ────────────────────────────────────
# Tax Advisory - $150,000 — no file created
print("SKIPPED INV-006_PwC.pdf (intentional gap)")
...
pdf.cell(0, 7, "From:    michael.torres@alvarezandmarsal.com", ln=True, fill=True)
pdf.cell(0, 7, "To:      jane.kim@acmecapital.com", ln=True)
...
pdf.multi_cell(0, 6,
    ...
    "  Invoice Reference:  AM-IT-2026-0312\n"
...
pdf.output(os.path.join(OUT, "EMAIL-001_Alvarez_Marsal.pdf"))
print("Created EMAIL-001_Alvarez_Marsal.pdf")
...
pdf.set_font("Helvetica", "", 10)
pdf.set_fill_color(240, 240, 240)
pdf.cell(0, 7, "From:    sarah.chen@acmecapital.com", ln=True, fill=True)
...
print("\nDone. Files in:", OUT)
print("Intentional gaps: INV-004 (FTI), INV-006 (PwC), INV-007 (HSR Filing)")
